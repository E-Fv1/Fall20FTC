...
namespace HERO_Simple_Application1
{
    public class Drive
    {
        ...
        public Drive(TalonSRX leftTalon_, TalonSRX rightTalon_)
        {
        ...
        private void simpleControls()
        {
            ...
            if (isTurning)
            {
                appliedLeftPercent += controller.GetAxis((uint) rightXAxis);
                appliedRightPercent += controller.GetAxis((uint) rightXAxis);
        ...
        private void reducePercentages()
        {
